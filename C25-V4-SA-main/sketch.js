...
function setup() {
 ...
 World.add(world,con);
  ...
  ground3 = Bodies.rectangle(10,200,10,400,ground_options);
  World.add(world,ground3); 

  ground4 = Bodies.rectangle(390,200,10,400,ground_options);
...
function draw() 
{
 ...
 push();
  ...
  rect(ground3.position.x,ground3.position.y,10,400);
  rect(ground4.position.x,ground4.position.y,10,400);
